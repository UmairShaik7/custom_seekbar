...
import static com.example.customseekbar.customseekbar.SeekBar.INDICATOR_ALWAYS_HIDE;
import static com.example.customseekbar.customseekbar.SeekBar.INDICATOR_ALWAYS_SHOW;
...
public class RangeSeekBar extends View {
    ...
    private void initSeekBar(AttributeSet attrs) {
        leftSB = new SeekBar(this, attrs, false);
        rightSB = new SeekBar(this, attrs, true);
    ...
    protected void onMeasureProgress(int w, int h) {
        int viewHeight = h - getPaddingBottom() - getPaddingTop()- paddingLeft;
        if (h <= 0) return;
    ...
    public SeekBarState[] getRangeSeekBarState() {
        ...
        leftSeekBarState.value = (int) leftSB.getProgress();
        ...
        if (seekBarMode == SEEKBAR_MODE_RANGE) {
            rightSeekBarState.value = (int) rightSB.getProgress();
