...
import static com.example.customseekbar.customseekbar.VerticalRangeSeekBar.DIRECTION_LEFT;
import static com.example.customseekbar.customseekbar.VerticalRangeSeekBar.DIRECTION_RIGHT;
import static com.example.customseekbar.customseekbar.VerticalRangeSeekBar.TEXT_DIRECTION_VERTICAL;
...
public class VerticalSeekBar extends SeekBar {
    ...
    VerticalSeekBar(RangeSeekBar rangeSeekBar, AttributeSet attrs, boolean isLeft) {
    ...
    private void drawVerticalIndicator(Canvas canvas, Paint paint, String text2Draw) {
